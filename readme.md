...
If the payload_type is command_response there will be no usable sensor data . 
If the payload_type it commodity_data there will be no usable command reponse data.
